...
import { install_bare_flag, install_command } from '../../../input.js'
                    ...
                    for ( const flag in installFlags ) {
                        ...
                        switch ( installFlags[ flag ] ) {
                            ...
                            case 'bare':
                                ...
                                process_parsed_argv.object[ process_parsed_argv.keys[ flag ] ] = await install_bare_flag(
                                    process_parsed_argv.object[ process_parsed_argv.keys[ flag ] ]
                                )
                                    .catch( async error => {
                                ...
                                react_dang.command.install.bare = true
